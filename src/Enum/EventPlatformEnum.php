...
class EventPlatformEnum
{
    ...
    public const PRODUCT_MODEL_UPDATED_DELTA_CODE = 'com.akeneo.pim.v1.product-model.updated.delta';
    public const PRODUCT_MODEL_UPDATED_DELTA_LABEL = 'Product Model Updated with Delta';
